    ...
    <div class="container bg-white p-5 rounded shadow-lg">
        ...
        <form action="{{ route('user.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" id="foto" name="foto" class="form-control @error('foto') input-invalid @enderror">
                @error('foto')
                    <div class="pesan-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="jurusan_id" id="jurusan_id" class="form-control @error('jurusan_id') input-invalid @enderror">
